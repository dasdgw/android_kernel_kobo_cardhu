...
void tegra_latency_allowance_update_tick_length(unsigned int new_ns_per_tick)
{
	...
	if (scale_factor > 1) {
		...
		tegra_set_latency_allowance(TEGRA_LA_G2PR, 1706);
		tegra_set_latency_allowance(TEGRA_LA_G2SR, 1706);
		tegra_set_latency_allowance(TEGRA_LA_G2DR, 1137);
		tegra_set_latency_allowance(TEGRA_LA_G2DW, 3413);
	}
}
