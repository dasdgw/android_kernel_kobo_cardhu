...
#define OTG_ENABLE_PIN TEGRA_GPIO_PT2
...
static struct regulator_consumer_supply smb347_vbus_supply[] = {
	REGULATOR_SUPPLY("usb_bat_chg", NULL),
};

static struct regulator_consumer_supply smb347_otg_vbus_supply[] = {
...
static struct smb347_charger_platform_data smb347_charger_pdata = {
	...
	.consumer_supplies = smb347_vbus_supply,
	.num_consumer_supplies = ARRAY_SIZE(smb347_vbus_supply),
	.otg_consumer_supplies = smb347_otg_vbus_supply,
	.num_otg_consumer_supplies = ARRAY_SIZE(smb347_otg_vbus_supply),
	.otg_enable_pin = OTG_ENABLE_PIN,
};

static struct i2c_board_info i2c4_smb347_board_info[] = {
	{
...
int __init cardhu_regulator_init(void)
{
	...
	//add for smb347 start
	#ifdef CONFIG_CHARGER_SMB347
		i2c_register_board_info(4, i2c4_smb347_board_info,
			ARRAY_SIZE(i2c4_smb347_board_info));
	#endif			
	//add for smb347 end
...
FIXED_REG(8, en_vdd_com,	en_vdd_com,	FIXED_SUPPLY(en_3v3_sys),	1,      0,      -EINVAL,		true,	1, 3300);
