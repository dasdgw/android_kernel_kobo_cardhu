...
//	{RT5639_HP_CALIB_AMP_DET, 0x0420},
	...
	{RT5639_SPK_VOL		, 0x8484},//SPKMIX -> SPKVOL
	{RT5639_SPO_CLSD_RATIO	, 0x0000},//0x4a
	{RT5639_SPO_L_MIXER	, 0x3800},//SPKVOLL -> SPOLMIX
...
//	{RT5639_REC_R2_MIXER	, 0x006f},//Mic2 -> RECMIXR
	...
	{RT5639_DAC1_DIG_VOL    , 0xadad},//0x19
	{RT5639_ADC_DIG_VOL	, 0x4f4f},//0x1c
	{RT5639_PRIV_INDEX	, RT5639_EQ_FC_HIP2},//PRb0
	{RT5639_PRIV_DATA	, 0x1e85},
	{RT5639_PRIV_INDEX	, RT5639_EQ_BW_HIP2},//PRb1
	{RT5639_PRIV_DATA	, 0x016a},
	{RT5639_PRIV_INDEX	, RT5639_EQ_GN_HIP2},//PRb2
	{RT5639_PRIV_DATA	, 0x1e8d},
	{RT5639_DRC_AGC_1 	, 0x6206},//0xb4
	{RT5639_DRC_AGC_2	, 0x1103},//0xb5
	{RT5639_ADC_BST_VOL     , 0x5000},//0x1e
	{RT5639_DSP_PATH2		, 0x0c00},//0x2e
	{RT5639_DIG_INF_DATA 	, 0x0a00},//0x2f
...
int rt5639_headset_detect(struct snd_soc_codec *codec, int jack_insert)
{
	...
	if(jack_insert) {
		...
		snd_soc_update_bits(codec, RT5639_DRC_AGC_1,
		    RT5639_DRC_AGC_MASK, RT5639_DRC_AGC_DIS);
	} else {
		snd_soc_update_bits(codec, RT5639_MICBIAS,
			RT5639_MIC1_OVCD_MASK,
			RT5639_MIC1_OVCD_DIS);
		snd_soc_update_bits(codec, RT5639_DRC_AGC_1,
		    RT5639_DRC_AGC_MASK, RT5639_DRC_AGC_EN);		
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMD:
		...
		snd_soc_update_bits(codec, RT5639_EQ_CTRL1,
			RT5639_EQ_UPD, 0);
		snd_soc_update_bits(codec, RT5639_EQ_CTRL1,
			RT5639_EQ_CD_MASK, RT5639_EQ_CD_DIS);	
		snd_soc_update_bits(codec, RT5639_EQ_CTRL2,
			RT5639_EQ_HPF2_MASK, RT5639_EQ_HPF2_DIS);
		break;
...
static DEVICE_ATTR(codec_reg, 0664, rt5639_codec_show, rt5639_codec_store);
