#ifndef ___YUV_SENSOR_MT9M114H__
#define ___YUV_SENSOR_MT9M114H__
...
#define SENSOR_IOCTL_SET_FLICKER		_IOW('o', 9, int)
#define SENSOR_IOCTL_GET_EV_STATUS      _IOW('o', 16, __u8)
#define SENSOR_IOCTL_GET_ISO_STATUS      _IOW('o', 17, __u8)
enum {
      YUV_ColorEffect = 0,
      YUV_Whitebalance,
      YUV_SceneMode,
...
enum {
      YUV_Exposure_Negative_3 = -3,
      YUV_Exposure_Negative_2,
...
#endif  /* ___YUV_SENSOR_MT9M114H__ */
