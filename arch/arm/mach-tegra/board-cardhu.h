...
#define TEGRA_GPIO_LDO1_EN		TEGRA_GPIO_PN1
...
#define CHARGER_STAT_GPIO	TEGRA_GPIO_PJ2
...
#define EN_1V8_CAMB				TEGRA_GPIO_PBB7
#define EN_2V85_CAM				TEGRA_GPIO_PR7
#define MT9M114_RESETN_GPIO		TEGRA_GPIO_PCC1
...
extern void wifibt_setpower(int onoff,enum wifibt_status state );
