...
#define CTPM_ID_BIT             6 // bit 6~7 , 00 for EDT, 01 for J-Touch
#define CTPM_ID_MASK			      (0x03 << CTPM_ID_BIT)
#define CTPM_OGS_ID			        (0x01 << CTPM_ID_BIT)
#define CTPM_GG_ID			    (0x10 << CTPM_ID_BIT)
#define CTPM_OGS_I2C_ADDR		    (0x70 >> 1)
#define CTPM_GG_I2C_ADDR		(0x72 >> 1)

//provided by vendor
#define PROC_MAX_TX     26
#define PROC_MAX_RX     16
